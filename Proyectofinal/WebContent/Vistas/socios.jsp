...
<h1 class="text-center" style=color:white;>Listado de Socios</h1>

<div  class="container" >
		<div class="row" >
				<a class="btn btn-primary col-4 m-4" href="SociosControllerr?accion=nuevo">Agregar Socio</a>
				...
				{
				String ruta="SociosControllerr?accion=modificar&id="+resultado.get(i).getId_socio();	
				String rutaE="SociosControllerr?accion=eliminar&id="+resultado.get(i).getId_socio();
				%>			
				<tr>
